...
| [docs/01_USAGE.md](docs/01_USAGE.md) | 插件安装、索引接入、REST 调用、查询扩展、suggest 和 bridge 的使用示例 |
...
- 在线建议：提供 `suggest` 与 `related_owners` 两类接口，支持拼音、纠错和 shard-local 缓存。
...
索引接入、查询 DSL、suggest 模式和完整参数说明见 [docs/01_USAGE.md](docs/01_USAGE.md) 与 [docs/01_API.md](docs/01_API.md)。