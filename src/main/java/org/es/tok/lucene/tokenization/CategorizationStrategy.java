...
public class CategorizationStrategy implements TokenizationStrategy {
    ...
    private static final String RE_CATEG = "(" + RE_ARAB + ")|(" + RE_ATOZ + ")|(" + RE_CJK + ")|(" + RE_DASH + ")|(" + RE_MASK + ")|(" + RE_NORD + ")";
    ...
    private String determineTokenType(Matcher matcher) {
        if (matcher.group(1) != null) return "arab";
        if (matcher.group(2) != null) return "atoz";
        if (matcher.group(3) != null) return "cjk";
        if (matcher.group(4) != null) return "dash";
        if (matcher.group(5) != null) return "mask";
        if (matcher.group(6) != null) return "nord";
        return "nord";
    }
}