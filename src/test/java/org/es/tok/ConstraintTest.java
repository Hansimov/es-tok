...
public class ConstraintTest {
        ...
        @Test
        public void testConstraintEqualityWithFields() {
                MatchCondition cond = new MatchCondition(
                                Arrays.asList("a"),
                                Collections.emptyList(),
                                Collections.emptyList(),
                ...
                SearchConstraint c1 = new SearchConstraint(
                                SearchConstraint.BoolType.AND, cond, List.of("title", "tags"));
        ...
        @Test
        public void testConstraintInequalityFields() {
                MatchCondition cond = new MatchCondition(
                                Arrays.asList("a"),
                                Collections.emptyList(),
                                Collections.emptyList(),
        ...
        @Test
        public void testConstraintWithAndWithoutFields() {
                MatchCondition cond = new MatchCondition(
                                Arrays.asList("a"),
                                Collections.emptyList(),
                                Collections.emptyList(),
                ...
                SearchConstraint withFields = new SearchConstraint(
                                SearchConstraint.BoolType.AND, cond, List.of("title"));
                SearchConstraint withoutFields = new SearchConstraint(
                                SearchConstraint.BoolType.AND, cond);
                assertTrue(withFields.hasFields());
                assertFalse(withoutFields.hasFields());
                assertNotEquals(withFields, withoutFields);
        }
        ...
        // ===== Per-constraint fields serialization tests =====

        @Test
        public void testConstraintsToMaps_withPerConstraintFields() {
                MatchCondition cond = new MatchCondition(
                                Arrays.asList("token"),
                                Collections.emptyList(),
                                Collections.emptyList(),
                ...
                assertEquals(1, maps.size());
                assertTrue(maps.get(0).containsKey("have_token"));
                assertTrue(maps.get(0).containsKey("fields"));
                @SuppressWarnings("unchecked")
                List<String> fields = (List<String>) maps.get(0).get("fields");
        ...
        @Test
        public void testConstraintsToMaps_notConstraintWithFields() {
                MatchCondition cond = new MatchCondition(
                                Arrays.asList("广告"),
                                Collections.emptyList(),
                                Collections.emptyList(),
                                ...
                                Collections.emptyList());
                SearchConstraint constraint = new SearchConstraint(
                                SearchConstraint.BoolType.NOT, cond, List.of("title"));
        ...
        @Test
        public void testConstraintsToMaps_withoutPerConstraintFields() {
                // Constraints without per-constraint fields should not have "fields" key
                MatchCondition cond = new MatchCondition(
                                Arrays.asList("token"),
                                Collections.emptyList(),
                                Collections.emptyList(),
                ...
                assertEquals(1, maps.size());
                assertTrue(maps.get(0).containsKey("have_token"));
                assertFalse(maps.get(0).containsKey("fields"));
        }

        @Test
        public void testConstraintsToMaps_orWithFields() {
                MatchCondition cond1 = new MatchCondition(
                                Arrays.asList("科技"),
                                Collections.emptyList(),
                                Collections.emptyList(),
